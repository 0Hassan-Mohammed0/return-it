...
class ReportLostPage extends StatefulWidget {
  ...
  const ReportLostPage({super.key, this.itemToEdit});
...
class _ReportLostPageState extends State<ReportLostPage> {
  ...
  final _locationController =
      TextEditingController(); // We might want a dropdown here too if specific locations
  ...
  void _performSearch() {
    ...
    _debounce = Timer(const Duration(milliseconds: 500), () async {
      ...
      final matches = await _databaseService.findSimilarItems(
          title: title, typeToSearch: 'found', location: _selectedLocation);
    ...
    try {
      ...
      if (!isEditing) {
        ...
        final similarItems = await _databaseService.findSimilarItems(
            title: _titleController.text.trim(), typeToSearch: 'found');
            ...
            builder: (ctx) => AlertDialog(
              ...
              content: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    const Text(
                        'We found found items that might match yours. Please check them before submitting:'),
    ...
    return InkWell(
      onTap: () {
        showModalBottomSheet(
          ...
          backgroundColor:
              const Color(0xFFF3F4F6), // Light grey/purple matching image
          builder: (context) {
            return Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(
                    height:
                        300, // Fixed height for list or flexible? User image shows a list. Let's make it scrollable if long.
                        ...
                        return InkWell(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              ...
                              textAlign: TextAlign
                                  .start, // Left aligned like image for English, Right for Arabic usually but image shows mixed.
                            ),
                          ),
                        );
                      },
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
            widget.itemToEdit != null ? 'Edit Lost Item' : 'Report Lost Item'),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      decoration:
                          _inputDecoration('e.g., Black Leather Wallet'),
                    ...
                    InkWell(
                      ...
                      child: IgnorePointer(
                        // Ignore pointer to let InkWell handle tap
                        child: TextFormField(
